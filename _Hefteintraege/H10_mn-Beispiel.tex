...
\begin{tabular}{c|c|c|c|c|c}
    ...
    \emphColA{1} & Her & \emphColA{1} & \emphColC{MTG} & \emphColC{MTG} & Haidh. \\
...
\emph{2 Spaltenpaare müssen zusammenpassen! $\Rightarrow$ Doppel-Join}\\\vspace{0.1cm}
    ...
    \emphColA{WHERE Lehrer.id = lehrer\_an\_schule.lehrer} \\
...
\begin{tabular}{c|c|c|c|c|c}
    id & kuerzel & lehrer & schule & id & ort \\\hline
    \emphColA{1} & Her & \emphColA{1} & \emphColC{MTG}   & \emphColC{MTG}   & Haidh. \\
    \emphColA{2} & Ext & \emphColA{2} & \emphColC{Dante} & \emphColC{Dante} & Sendl. \\
    \emphColA{2} & Ext & \emphColA{2} & \emphColC{MTG}   & \emphColC{MTG}   & Haidh. \\
\end{tabular}\\
