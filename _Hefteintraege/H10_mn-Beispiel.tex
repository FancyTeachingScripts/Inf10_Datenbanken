...
\begin{tabular}{c|c|c|c|c|c}
    ...
    \emphColor{violet}{1} & Her & \emphColor{violet}{1} & \emphColC{MTG} & \emphColC{MTG} & Haidh. \\
...
\emph{2 Spaltenpaare müssen zusammenpassen! $\Rightarrow$ Doppel-Join}\\\vspace{0.1cm}
    ...
    \emphColor{violet}{WHERE Lehrer.id = lehrer\_an\_schule.lehrer} \\
...
\begin{tabular}{c|c|c|c|c|c}
    id & kuerzel & lehrer & schule & id & ort \\\hline
    \emphColor{violet}{1} & Her & \emphColor{violet}{1} & \emphColC{MTG}   & \emphColC{MTG}   & Haidh. \\
    \emphColor{violet}{2} & Ext & \emphColor{violet}{2} & \emphColC{Dante} & \emphColC{Dante} & Sendl. \\
    \emphColor{violet}{2} & Ext & \emphColor{violet}{2} & \emphColC{MTG}   & \emphColC{MTG}   & Haidh. \\
\end{tabular}\\
