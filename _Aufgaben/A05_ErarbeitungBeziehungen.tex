\Aufgabe[5]{Tabellenbeziehungen}{
    ...
    \begin{tikzpicture}
        ...
        \node[inner sep=0pt, right = 2cm of imgdorf01] (imgbew01) {%
             \includegraphics[width=0.5\textwidth]{_Aufgaben/img/A05/A05_Bew_01.png}
        };
        \node[inner sep=0pt, below=-1pt of imgbew01] (imgbew02) {%
             \includegraphics[width=0.5\textwidth]{_Aufgaben/img/A05/A05_Bew_02.png}
        };
        \node[inner sep=0pt, below=-1pt of imgbew02] (imgbew03) {%
             \includegraphics[width=0.5\textwidth]{_Aufgaben/img/A05/A05_Bew_03.png}
        };
        \node[inner sep=0pt, below=-1pt of imgbew03] (imgbew04) {%
             \includegraphics[width=0.5\textwidth]{_Aufgaben/img/A05/A05_Bew_04.png}
        };
        \node[inner sep=0pt, below=-1pt of imgbew04] (imgbew05) {%
             \includegraphics[width=0.5\textwidth]{_Aufgaben/img/A05/A05_Bew_05.png}
        };
        \node[inner sep=0pt, below=-1pt of imgbew05] (imgbew06) {%
             \includegraphics[width=0.5\textwidth]{_Aufgaben/img/A05/A05_Bew_06b.png}
        };
        \node[inner sep=0pt, below=-1pt of imgbew06] (imgbew07) {%
             \includegraphics[width=0.5\textwidth]{_Aufgaben/img/A05/A05_Bew_07b.png}
        };
...
\UnterAufgabe[5]{Tabellenbeziehung im Klassendiagramm}{
    \ifbeamer\else\emphColB{Tabellenbeziehung im Klassendiagramm}\fi
    \begin{enumerate}
        \item Ergänze das Klassendiagramm entsprechend den beiden Tabellen oben.
